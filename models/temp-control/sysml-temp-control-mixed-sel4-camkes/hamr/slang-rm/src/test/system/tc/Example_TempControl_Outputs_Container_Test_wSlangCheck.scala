...
import art.Art
import tc._
import tc.TempControl_Outputs_Container_SlangCheck._
import Example_TempControl_Outputs_Container_Test_wSlangCheck._
import tc.TempControl_Outputs_Container_Profile
import tc.TempControl_Outputs_Container_Profile._
...
class Example_TempControl_Outputs_Container_Test_wSlangCheck
  ...
  def run(config: SystemTestConfiguration): Unit = {
    ...
    def next: Option[TempControl_Outputs_Container] = {
      try {
...
object Example_TempControl_Outputs_Container_Test_wSlangCheck {
  ...
  def genJsons(echo: B): B = {
    if (Os.env("JENKINS_HOME").isEmpty) { // don't generate these when CI
      ...
      val inst = new Example_TempControl_Outputs_Container_Test_wSlangCheck()
