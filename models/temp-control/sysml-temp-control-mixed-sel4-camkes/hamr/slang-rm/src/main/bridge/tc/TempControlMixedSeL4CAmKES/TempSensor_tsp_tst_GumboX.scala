...
object TempSensor_tsp_tst_GumboX {
  ...
  @strictpure def compute_CEP_Post (
      api_tempChanged: Option[art.Empty],
      api_currentTemp: TempControlMixedSeL4CAmKES.Temperature): B = { // D-Inv-Guard: Datatype invariants for the types associated with tst's state variables and outgoing ports
    val a = TempControlMixedSeL4CAmKES.Temperature.D_Inv_Temperature(api_currentTemp)

    // I-Guar-Guard: Integration constraints for tst's outgoing ports
    val b = I_Guar_currentTemp(api_currentTemp)
