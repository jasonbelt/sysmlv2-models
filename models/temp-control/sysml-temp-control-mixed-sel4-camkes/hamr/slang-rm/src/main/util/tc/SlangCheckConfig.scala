...
@datatype class Config_TempControl_Inputs_Container(attempts: Z, verbose: B, filter: TempControl_Inputs_Container => B) {}
...
@datatype class Config_TempControl_Outputs_Container(attempts: Z, verbose: B, filter: TempControl_Outputs_Container => B) {}
